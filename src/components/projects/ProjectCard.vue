<template>
  <BaseCard border-color="green" padding="md" aria-label="Personal project entry" tag="article">
    <div class="mb-4">
      <h3 class="mb-2 text-xl font-bold text-gray-900 dark:text-white">
        {{ translatedTitle }}
      </h3>
      <div v-if="hasDates" class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300">
        <svg
        ...
        <span
          v-else-if="project.startDate && !project.endDate"
    ...
    <p v-if="translatedDescription" class="mb-4 text-sm leading-relaxed text-gray-700 dark:text-gray-200">
      {{ translatedDescription }}
    </p>

    <div v-if="translatedTechStack" class="mb-4 border-t border-gray-200 pt-4 dark:border-gray-700">
