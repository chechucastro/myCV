<template>
  <BaseCard border-color="purple" padding="sm" aria-label="Recommendation entry" tag="article">
    ...
    <blockquote
      class="relative border-purple-200 pl-3 text-gray-700 sm:border-l-4 sm:pl-6 dark:border-purple-700 dark:text-gray-200"
    >
